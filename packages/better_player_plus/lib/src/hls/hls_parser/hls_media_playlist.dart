...
class HlsMediaPlaylist extends HlsPlaylist {
  ...
  factory HlsMediaPlaylist.create({
    ...
    int? computedStartOffsetUs = startOffsetUs;
    if (computedStartOffsetUs != null && computedStartOffsetUs < 0) {
      computedStartOffsetUs = (durationUs ?? 0) + computedStartOffsetUs;
    }

    return HlsMediaPlaylist._(
      playlistType: playlistType,
      startOffsetUs: computedStartOffsetUs,
